...
BRONTZ = render('BRONTZ', colors=['red', 'cyan'], align='center')
print("============================================================")
print(f'''
{BRONTZ}
...
def amir():
    os.system('clear')
    output = (f"{cyan}▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱\n"
f"{cyan} {white} HITS : {green}{hits} \n"
f"{white} BAD INSTA: {red}{badinsta} \n"
f"{white} BAD EMAIL: {yellow}{bademail} \n"
f"{white} GOOD IG : {orange}{goodig} {cyan}\n"

f"{white} DEV ; @brontzpy  {cyan}"
...
def InfoAcc(username, gg):
    ...
    try:
        rrr = requests.get(
            f'https://api-ig.storiesig.info/api/userInfoByUsername/{username}',
